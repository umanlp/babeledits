...
from ..models.babelreft import BabelReFTHyperParams, apply_babelreft_to_model
from ..models.reft import ReFTHyperParams, apply_reft_to_model
...
ALG_DICT = {
    ...
    "BabelReFT": apply_babelreft_to_model,
    "ReFT": apply_reft_to_model,
}
