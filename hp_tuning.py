...
def main(cfg: DictConfig) -> None:
    ...
    if cfg.log_subdir:
        ...
        log_dir = to_absolute_path(
            f"logs/{cfg.log_subdir}/{sweep_id}/{model_name}/{method_dir_name}/{cfg.edit_lang}/{cfg.prompt_type}/{run_id}"
        )
    ...
    if cfg.pre_eval_only:
        ...
        for metric in cfg.metrics:
            lang_to_score = {
                lang: summary["post"]["portability"][f"xlt-{cfg.prompt_type}-{lang}"][
                    metric
                ]
